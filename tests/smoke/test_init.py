...
class TestInitModule:
    ...
    def test_init_module_is_empty(self):
        ...
        assert len(content) <= 100, f"__init__.py should be mostly empty, but has {len(content)} characters"
        ...
        if content:
            ...
            assert len(non_comment_lines) == 0, "__init__.py should not have non-comment code"
