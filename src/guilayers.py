...
runbuttons_layer= sg.Frame('Activate simulation', 
                           [
                             [sg.Text('Graphics toggle',size = (21,1),font=('Helvetica', 12), text_color='black'),
                              sg.Button('On' if selectcomponents['Graphics'] else 'Off' , size=(3, 1), button_color='white on green' if selectcomponents['Graphics'] else 'white on red', key='-GRAPHICS-')],
...
dicom_information_layer = sg.Frame('Instructions on the usage of the DICOM adjustments', 
                             [ 
                               [sg.Text('The programme automatically centres the isocentre of the treatment plan to the isocentre of the beam.')],
                               [sg.Text('Make any adjustments relative to the ioscentre of the treatment plan.')],
                               [sg.Text('Use the other tabs to make edits to other parameters like collimator openings and beam current. ')],
                             ]) 

dicom_translation_layer = sg.Frame('DICOM adjustments',
                    [
                        [sg.Text('TransX',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='0.',key='-DICOM_TX-',size=(10,1), font=('Helvetica', 12), enable_events=True)],
                        [sg.Text('TransY',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='0.',key='-DICOM_TY-',size=(10,1), font=('Helvetica', 12), enable_events=True)],
                        [sg.Text('TransZ',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='0.',key='-DICOM_TZ-',size=(10,1), font=('Helvetica', 12), enable_events=True)],
                        [sg.Text('RotX',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='-90',key='-DICOM_RX-',size=(10,1), font=('Helvetica', 12), enable_events=True)], 
                    ])

dicom_scan_layer = sg.Frame('DICOM adjustments',
                    [
                        [sg.Text('Start angle',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='0.',key='-DICOM_STARTROT-',size=(10,1), font=('Helvetica', 12), enable_events=True)],
                        [sg.Text('Stop angle',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='0.',key='-DICOM_STOPROT-',size=(10,1), font=('Helvetica', 12), enable_events=True)],
                        [sg.Text('Clockwise or anticlock',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='0.',key='-DICOM_DIRECTROT-',size=(10,1), font=('Helvetica', 12), enable_events=True)],
                        [sg.Text('Beam current',size = (8,1),font=('Helvetica', 12), text_color='black'),
                        sg.In(default_text='-90',key='-DICOM_BEAMCURRENT-',size=(10,1), font=('Helvetica', 12), enable_events=True)], 
                    ])
