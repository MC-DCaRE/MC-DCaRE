...
imaging_scan_layer = sg.Frame('Set up imaging parameters', 
                      [ [sg.Text('Start angle',size = (12,1), text_color='black'),
                        ...
                        [sg.Text('CBCT or kVkV',size = (12,1), text_color='black'),
                         sg.Combo(['CBCT Clockwise', 'CBCT Anticlockwise', 'kVkV'], default_value='CBCT Clockwise' ,key='-DIRECTROT-', readonly=True ,enable_events=True, size=(15,1))],
