...
width = 32; %Width of the field at isocentre in the sup-inf direction (cm) this is Y-blades on the source <<<<CHECK THIS>>>>>
kerma = (numAnglesTrue/numAnglesSimmed).*[0.0137,0.017,0.0175,0.0171,0.0171,0.0171,0.0171]; %Air kerma per projection at each sub-field coordinate (mGy).
