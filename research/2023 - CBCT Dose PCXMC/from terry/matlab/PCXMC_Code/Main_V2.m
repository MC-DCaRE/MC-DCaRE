...
width = 20.6; %Width of the field at isocentre in the sup-inf direction (cm) this is Y-blades on the source <<<<CHECK THIS>>>>>
...
%average male
%for head, 1.8m tall, 88kg, anterior radius of head 11cm, posterior radius 7cm.
