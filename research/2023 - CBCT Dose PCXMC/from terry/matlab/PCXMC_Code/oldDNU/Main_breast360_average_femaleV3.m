...
numAnglesSimmed = 50; %Number of projections/angles to be used in the simulation
...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.0125,0.0309,0.0936,0.1393,0.0936,0.0309,0.0125]; %Air kerma per projection at each sub-field coordinate (mGy).
filtration = [10.153,10.928,9.4467,8.2417,9.4467,10.928,10.153]; %Total filtration at each sub-field coordinate (mm Al)
