...
%average female
%body, 1.50m tall, 50kg, A/P dimensions of body 20cm, Lateral 40cm

%Phantom geometry details
%average female
%body, 1.65m tall, 72kg, A/P dimensions of body 20cm, Lateral 40cm, 34cm
%with no arms
...
pDepth = 10; %Phantom's body depth (cm), need to make these both the same for head???? i think they do need to be the same for head.
...
height = 165; %Phantom's height (cm)
mass = 72; %Phantom's mass (kg)
