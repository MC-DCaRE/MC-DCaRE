...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.0007,0.0039,0.0061,0.0174,0.0269,0.0301,0.0269,0.0174,0.0061,0.0039,0.0007]; %Air kerma per projection at each sub-field coordinate (mGy).
filtration = [11.85,24.48,26.52,18.31,12.17,11.31,12.17,18.31,26.52,24.48,11.85]; %Total filtration at each sub-field coordinate (mm Al)
