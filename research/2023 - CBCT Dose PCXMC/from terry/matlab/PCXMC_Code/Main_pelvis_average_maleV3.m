...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.0701,0.0681,0.0548,0.0247,0.0053,0.0053,0.0053]; %Air kerma per projection at each sub-field coordinate (mGy).
filtration = [8.00,8.08,8.58,9.91,9.32,9.32,9.32]; %Total filtration at each sub-field coordinate (mm Al)
