...
pWidth = 15; %Dual variable: If headScan = false , this represents the phantom's body width (cm) divided by 2. If headScan = true, anterior radius of phantom's head (cm)
pDepth = 9; %Phantom's body depth (cm) divided by 2, need to make these both the same for head???? i think they do need to be the same for head.
