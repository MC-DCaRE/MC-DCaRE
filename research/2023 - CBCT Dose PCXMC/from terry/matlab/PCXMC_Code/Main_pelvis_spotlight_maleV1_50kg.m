...
z = 8; %Sup-Inf offset (cm)(for head 85 gave higher dose than 88cm)
...
pWidth = 15; %Dual variable: If headScan = false , this represents the phantom's body lateral width (cm). If headScan = true, anterior radius of phantom's head (cm)
...
pDepth = 9; %Phantom's body depth (cm), need to make these both the same for head???? i think they do need to be the same for head.
