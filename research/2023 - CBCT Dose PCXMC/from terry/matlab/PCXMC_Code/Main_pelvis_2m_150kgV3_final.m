...
z = 5; %Sup-Inf offset (cm)(for head 85 gave higher dose than 88cm
...
%pelvis, 360 degrees, startsource 180 - stopsource 180 on the linac only, this
...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.00701,0.0681,0.0548,0.0247,0.0053,0.0053,0.0053]; %Air kerma per projection at each sub-field coordinate (mGy).
...
%average male
%body, 2.0m tall, 150kg, A/P dimensions of body 27cm, Lateral 46cm
