...
%modelled the 5cm centre below iso (+2.5cm either side of the centre so 
%down to +7.5cm in PCXMC) and anterior to iso to 25cm (+2.5cm) 
subFieldCoords = [0, 0, 0, 0, 0, 0, 0 ;5, 0, -5, -10, -15, -20, -25]; %Sub-field coordinates defined a gantry 0, eg. [0, 0, 0, ... ; y1, y2, y3, ...] (coordinates of centres of sub-fields)
