...
z = 54; %Sup-Inf offset (cm)(for head 85 gave higher dose than 88cm)
...
pDepth = 11; %Phantom's body depth (cm), need to make these both the same for head???? i think they do need to be the same for head.
