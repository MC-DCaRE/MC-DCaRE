...
filtration = [8.004,8.083,8.581,9.911,8.892,8.892,8.892]; %Total filtration at each sub-field coordinate (mm Al)

%Phantom geometry details
%small person
%body, 2m tall, 150kg, A/P dimensions of body 27cm, Lateral 46cm

pWidth = 23; %Dual variable: If headScan = false , this represents the phantom's body width (cm) divided by 2. If headScan = true, anterior radius of phantom's head (cm)
pDepth = 13.5; %Phantom's body depth (cm) divided by 2, need to make these both the same for head???? i think they do need to be the same for head.
