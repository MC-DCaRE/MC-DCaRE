...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.0022,0.0124,0.0304,0.0501,0.0627,0.0690,0.0699,0.0697,0.0683,0.0683,0.0683]; %Air kerma per projection at each sub-field coordinate (mGy).
filtration = [8.308,10.315, 9.581,8.809,8.249,8.06,8.074,7.905,8.031,7.891,7.891]; %Total filtration at each sub-field coordinate (mm Al)

%Phantom geometry details
%average male
%body, 1.8m tall, 88kg, A/P dimensions of body 22cm, Lateral 42cm
...
%pDepth is same as above, use half the body width.
