...
pWidth = 11; %Dual variable: If headScan = false , this represents the phantom's body width (cm). If headScan = true, anterior radius of phantom's head (cm)
pDepth = 11; %Phantom's body depth (cm), need to make these both the same for head????
