...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.0046,0.0057,0.0058,0.0057,0.0057,0.0057,0.0057]; %Air kerma per projection at each sub-field coordinate (mGy).
filtration = [8.581,8.083,8.004,7.961,7.891,7.891,7.891]; %Total filtration at each sub-field coordinate (mm Al)
