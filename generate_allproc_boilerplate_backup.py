...
Seed = '9'
NumberOfThreads = '4'
G4DataDirectory = 'test_boilerplate_path_change'
World_HLX = '120'
World_HLY = '120'
World_HLZ = '120'
...
print('len of boundaries_list:',len(boundaries_list))
air = '"Air"'
pmma = '"PMMA"'
...
#centre
    ...
    if len(boundaries_list) != 0: 
        for component_name, values in zip(boundaries_name_list*len([*product(*(my_arange(*b) for b in boundaries_list))]),product(*(my_arange(*b) for b in boundaries_list))):
            ...
            #ChamberPlugDose_tle_Zbins,i=str(values[i]),i+1
            #ChamberPlugDose_dtm_Zbins,i=str(values[i]),i+1
            #ChamberPlugDose_dtw_Zbins,i=str(values[i]),i+1
            #ChamberPlugDose_dtmd_Zbins,i=str(values[i]),i+1
