...
z = 71; %Sup-Inf offset (cm)(for head 85 gave higher dose than 88cm
...
subFieldWidths = [1.5,5,5,5,5,5,1.55]; %Width of each sub-field at each sub-field coordinate (cm) (X-direction blades, <<<<CHECK THIS>>>>>)
...
%average male
%for head, 1.5m tall, 50kg, anterior radius of head XXXcm, posterior radius
%XXXcm. however the lateral profile of the larger radius of the head does
%reduce in size meaning chooisng XXcm will put reference points out of the
%phantom.
