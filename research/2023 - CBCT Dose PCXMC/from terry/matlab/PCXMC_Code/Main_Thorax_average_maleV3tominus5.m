...
subFieldCoords = [0, 0, 0, 0, 0, 0, 0 ; 25, 20, 15, 10, 5, 0, -5]; %Sub-field coordinates defined a gantry 0, eg. [0, 0, 0, ... ; y1, y2, y3, ...] (coordinates of centres of sub-fields)
...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.0171,0.0171,0.0171,0.0171,0.0175,0.0170,0.0137]; %Air kerma per projection at each sub-field coordinate (mGy).
filtration = [7.891,7.891,7.891,7.96,8.004,8.083,8.581]; %Total filtration at each sub-field coordinate (mm Al)
