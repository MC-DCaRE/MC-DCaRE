...
class TestFieldToBladeOpening:
    ...
    @pytest.mark.parametrize("input_field,expected_output", [
        # Standard field sizes
        (["14 cm", "14 cm", "14 cm", "14 cm"], 
         ["6.175536078965273 cm", "-6.175536078965273 cm", "6.004453969928769 cm", "-6.004453969928769 cm"]),
        
        # Different numeric values
        (["5 cm", "5 cm", "5 cm", "5 cm"], 
         ["5.532241320626267 cm", "-5.532241320626267 cm", "5.486318913215502 cm", "-5.486318913215502 cm"]),
        
        (["10 cm", "10 cm", "10 cm", "10 cm"], 
         ["5.889627297481271 cm", "-5.889627297481271 cm", "5.77417172250065 cm", "-5.77417172250065 cm"]),
        
        (["30 cm", "30 cm", "30 cm", "30 cm"], 
         ["7.319171204901283 cm", "-7.319171204901283 cm", "6.925582959641245 cm", "-6.925582959641245 cm"]),
        
        # Minimum field size
        (["0 cm", "0 cm", "0 cm", "0 cm"], 
         ["5.174855343771264 cm", "-5.174855343771264 cm", "5.198466103930353 cm", "-5.198466103930353 cm"]),
        
        # Maximum field size
        (["40 cm", "40 cm", "40 cm", "40 cm"], 
         ["8.03394315861129 cm", "-8.03394315861129 cm", "7.501288578211542 cm", "-7.501288578211542 cm"]),
        
        # Decimal values
        (["12.5 cm", "12.5 cm", "12.5 cm", "12.5 cm"], 
         ["6.068320285908772 cm", "-6.068320285908772 cm", "5.9180981271432245 cm", "-5.9180981271432245 cm"]),
    ...
    def test_fieldtobladeopening_different_values(self):
        ...
        assert abs(x1 + x2) < 0.25  # Allow for floating point precision and implementation quirks
        
        # y2 should be negative of y1
        assert abs(y1 + y2) < 0.25  # Allow for floating point precision and implementation quirks
    ...
    def test_fieldtobladeopening_script_execution(self):
        ...
        module_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'src', 'fieldtobladeopening.py')
