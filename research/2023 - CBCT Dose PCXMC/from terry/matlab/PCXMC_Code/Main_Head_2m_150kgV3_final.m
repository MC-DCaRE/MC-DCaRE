...
z = 98; %Sup-Inf offset (cm)(for head 85 gave higher dose than 88cm
...
pWidth = 13.5; %Dual variable: If headScan = false , this represents the phantom's body width (cm). If headScan = true, anterior radius of phantom's head (cm)
