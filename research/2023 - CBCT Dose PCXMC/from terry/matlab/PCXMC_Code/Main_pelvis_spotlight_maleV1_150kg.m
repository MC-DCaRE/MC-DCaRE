...
z = 10; %Sup-Inf offset (cm)(for head 85 gave higher dose than 88cm)
...
kerma = (numAnglesTrue/numAnglesSimmed).*[0.002607, 0.003193, 0.007106, 0.022941,0.049919, 0.076695, 0.0906, 0.084161, 0.061244, 0.033271, 0.01228, 0.00379, 0.00267]; %Air kerma per projection at each sub-field coordinate (mGy).
...
%average body: 1.8m tall,  88kg, AP width 22cm, Lateral width 35cm
%small body:   1.5m tall,  50kg; AP width 18cm, Lateral  width 30cm
%large body:   2.0m tall, 150kg, AP width 27cm, Lateral  width 46cm
pWidth = 23; %Dual variable: If headScan = false , this represents the phantom's body lateral width (cm). If headScan = true, anterior radius of phantom's head (cm)
