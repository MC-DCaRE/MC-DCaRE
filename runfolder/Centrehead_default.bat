...
s:Sc/ChamberPlugDose_tle/OutputFile="datafolder/Centrehead_defaultChamberPlug_tle"
s:Sc/ChamberPlugDose_dtm/OutputFile="datafolder/Centrehead_defaultChamberPlug_dtm"
s:Sc/ChamberPlugDose_dtw/OutputFile="datafolder/Centrehead_defaultChamberPlug_dtw"
